...
class Parser
{
    ...
    public Befehl liefereBefehl()
    {
        ...
        if(zerleger.hasNext()) {
            wort1 = zerleger.next().toLowerCase();     // erstes Wort lesen
            if (zerleger.hasNext()) {
                wort2 = zerleger.next().toLowerCase();    // zweites Wort lesen
    ...
    public String befehleZeigen(){
        return befehle.gibBefehleListe();
    }
}
